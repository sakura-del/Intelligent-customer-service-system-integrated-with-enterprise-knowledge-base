...
[![文档](https://img.shields.io/badge/文档-在线查看-5e35b1?style=flat-square&logo=materialformkdocs&logoColor=white)](https://intelligent-cs-cs-8p2.pages.dev/)
...
> :material-book-open: **[完整使用文档](https://intelligent-cs-cs-8p2.pages.dev/)** — 包含快速开始、安装部署、配置说明、架构设计、各功能模块教程、API 参考、示例与 FAQ，支持中英双语切换。
...
- **文档同步**：每次功能新增或删除必须同步更新 `docs/` 下对应文档（中英双语），详见 [贡献指南](https://intelligent-cs-cs-8p2.pages.dev/contributing/)

## 文档

完整使用文档基于 MkDocs Material 构建，支持中英双语，部署在 Cloudflare Pages：

- **在线访问**：https://intelligent-cs-cs-8p2.pages.dev/
- **本地预览**：
